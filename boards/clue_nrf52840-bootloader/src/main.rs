...
const LED_ON_PIN: nrf52840::gpio::Pin = nrf52840::gpio::Pin::P1_01;
...
pub unsafe fn main() {
    ...
    let cdc = components::cdc::CdcAcmComponent::new(
        ...
        capsules_core::usb::cdc::MAX_CTRL_PACKET_SIZE_NRF52840,
        0x2341,
        0x005a,
        strings,
        mux_alarm,
    ...
    .finalize(components::usb_cdc_acm_component_static!(
        nrf52::usbd::Usbd,
        nrf52::rtc::Rtc
    ));
